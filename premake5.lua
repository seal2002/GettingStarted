...
project (s)
    ...
    configuration "windows"
        postbuildcommands { "xcopy ..\\code\\" .. s .. "\\*.tga" }
end

-- List of Project
Projects = { "1.HelloWindow", "2.1.HelloTriangle", "2.2.HelloTriangleIndex", "2.3.Exercise1", "2.4.Exercise2",
             "2.5.Exercise3", "2.6.HelloTriangleNonVAO", "3.1.Shader", "3.2.ShaderClassInterpolation", "3.3.ShaderUniformTransform",
